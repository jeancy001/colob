  ...
  return (
    <div className="min-h-full pb-8">
      <div className="relative h-28 bg-gradient-to-br from-primary/30 via-primary/10 to-accent/15">
        <div className="absolute right-3 top-3 flex items-center gap-1.5">
          ...
          <Link
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full bg-background/60 backdrop-blur active:scale-95"
          >
      ...
      <div className="px-4">
        ...
        <p className="mt-6 text-center text-xs text-muted-foreground">KOLOB · v1.0 · Made for Africa</p>
      </div>
    </div>
  )
}
