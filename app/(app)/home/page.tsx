...
export default function HomePage() {
  ...
  return (
    <div className="pb-8">
      {/* Header */}
      <header className="sticky top-0 z-20 flex items-center gap-2.5 border-b border-border bg-background/85 px-4 py-3 backdrop-blur">
        <Link href="/profile">
      ...
      <div className="px-4 pt-4">
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            <p className="font-display text-sm font-semibold">3 {t('home.newMatches')}</p>
