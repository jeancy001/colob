...
export function MobileFrame({ children }: { children: ReactNode }) {
  return (
    <div className="flex min-h-dvh items-center justify-center bg-[oklch(0.13_0.008_165)] sm:p-6">
      ...
      <div className="relative flex h-dvh w-full flex-col overflow-hidden bg-background sm:h-[880px] sm:max-h-[92vh] sm:w-[400px] sm:rounded-[2.75rem] sm:border-[6px] sm:border-[oklch(0.28_0.01_165)] sm:shadow-2xl sm:shadow-black/50">
        <StatusBar />
